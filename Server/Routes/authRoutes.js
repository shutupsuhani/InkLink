...
router.post('/signup', async (req, res) => {
  const { firstname,lastname,username, password, email,profilepicture } = req.body;
  ...
  return res.status(200).json({newUser, status: true, message: 'Successfully registered' });
});
